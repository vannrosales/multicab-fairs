...
export declare function render(component: ReactElement<any>, { css, cssOptions, debugCompiled, ...options }?: RenderOptions): {
    rerender: (component: import("react").ReactElement) => void;
    rerenderAsync: (component: import("react").ReactElement) => Promise<void>;
    update: (component: import("react").ReactElement) => void;
    updateAsync: (component: import("react").ReactElement) => Promise<void>;
    unmount: () => void;
...
export declare function createMockComponent<const C extends ReactComponent<any>, const M extends EnableCssInteropOptions<C>>(Component: C, mapping: M & EnableCssInteropOptions<C>): import("react").ForwardRefExoticComponent<import("react").RefAttributes<unknown>> & {
    mock: any;
};
export declare function createRemappedComponent<const C extends ReactComponent<any>, const M extends EnableCssInteropOptions<C>>(Component: C, mapping: M & EnableCssInteropOptions<C>): import("react").ForwardRefExoticComponent<import("react").RefAttributes<unknown>> & {
    mock: any;
};
