...
export declare function getEasing(timingFunction: EasingFunction, Easing: (typeof import("react-native-reanimated"))["Easing"]): ((t: number) => number) | import("react-native-reanimated").EasingFunctionFactory;
