...
function AnimatedInterop({ component, props, style, }) {
    const { useAnimatedStyle } = require("react-native-reanimated");
    const animatedStyle = useAnimatedStyle(() => {
        function flattenAnimatedProps(value) {
            ...
            if (Array.isArray(value))
                return value.map(flattenAnimatedProps);
    ...
    return (0, react_1.createElement)(component, { ...props, style: animatedStyle });
}
